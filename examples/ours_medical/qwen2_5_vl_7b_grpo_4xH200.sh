...
export RAY_TMPDIR=/tmp/ray_grpo_tc
...
TRAIN_FILE="data/rl_3_evidence_papo_jsonl/train_cepo_lite_80_10_10_grpo.jsonl"
...
EXP_NAME="medical_evidence__grpo__7b__ep${TOTAL_EPOCHES}_rb${ROLLOUT_BATCH_SIZE}_gb${GLOBAL_BATCH_SIZE}"
